...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.w3conext.jailbreak_root_detection.JailbreakRootDetectionPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin jailbreak_root_detection, com.w3conext.jailbreak_root_detection.JailbreakRootDetectionPlugin", e);
    }
    try {
